...
const variants = {
  ...
  FillBluegray9003f01: "bg-blue_gray_900_3f_01",
} as const;
const shapes = {
  RoundedBorder12: "rounded-[12px]",
  RoundedBorder4: "rounded",
} as const;
const sizes = { sm: "p-[7px]", md: "p-3" } as const;
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#2c5dfe",
              "&:hover": { backgroundColor: "#2c5dfe", color: "#ffffff" },
            }),
