    ...
    <>
      <div className="bg-black_900 flex flex-col font-inter items-end justify-start mx-auto sm:pl-5 pl-[21px] py-[21px] w-full">
        <div className="flex flex-col items-center justify-start mb-[41px] md:px-5 w-[93%] md:w-full">
          ...
          <div
            className="bg-cover bg-no-repeat flex flex-col h-14 items-start justify-start mt-[27px] p-3 w-[27%] md:w-full"
            style={{ backgroundImage: "url('images/img_group120.svg')" }}
          >
            <Line className="bg-blue_A700 h-8 md:ml-[0] ml-[9px] w-px" />
          </div>
          <Input
            wrapClassName="flex mt-5 w-[27%]"
            ...
            size="md"
            variant="OutlineGray30043"
          ></Input>
          <div className="flex flex-row items-end justify-between mt-6 w-[28%] md:w-full">
            <CheckBox
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly mt-[123px] w-full">
            ...
            <Img
              src="images/img_shadowbackground_2.png"
