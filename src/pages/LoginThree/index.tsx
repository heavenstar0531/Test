    ...
    <>
      <div className="bg-black_900 flex flex-col font-inter items-end justify-start mx-auto sm:pl-5 pl-[21px] py-[21px] w-full">
        <div className="flex flex-col items-start justify-start mb-[41px] md:px-5 w-[93%] md:w-full">
          ...
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[468px] mt-[65px] w-[28%] md:w-full">
            <div className="flex flex-col gap-[27px] items-center justify-start w-full">
              ...
              <div className="flex flex-col items-start justify-start w-full">
                ...
                <Input
                  ...
                  variant="OutlineGray90006"
                ></Input>
                <div className="flex flex-row items-end justify-between mt-6 w-full">
                  <CheckBox
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly mt-[76px] w-full">
            ...
            <Img
              src="images/img_shadowbackground_4.png"
