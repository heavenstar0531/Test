    ...
    <>
      <div className="bg-black_900 font-inter h-[900px] mx-auto pl-4 relative w-full">
        ...
        <div className="absolute h-[900px] inset-y-[0] my-auto md:px-5 right-[0] w-[93%] md:w-full">
          ...
          <div className="absolute flex flex-row gap-2 items-center justify-center right-[3%] top-[2%] w-[14%]">
            <div className="flex flex-col items-center justify-start w-[70%]">
              <Text className="font-semibold text-white_A700" variant="body10">
                Alexander Yeromin
              </Text>
          ...
          <div className="absolute flex flex-col gap-6 inset-x-[0] items-start justify-start mx-auto top-[11%] w-[95%]">
            ...
            <div className="md:h-[181px] h-[184px] relative w-[10%]">
              <div className="absolute flex flex-col gap-[17px] h-max inset-[0] items-start justify-center m-auto w-full">
                <Img
        ...
        <div className="absolute flex flex-col md:gap-10 gap-[132px] items-center justify-start left-[2%] md:px-5 top-[30%] w-[4%]">
          <div
            className="bg-cover bg-no-repeat flex flex-col h-8 items-center justify-start w-8"
            style={{ backgroundImage: "url('images/img_favorite.svg')" }}
          >
            <Img
              src="images/img_favorite.svg"
              className="h-8 w-8"
