      ...
      <div className="bg-black_900 flex flex-col font-inter items-center justify-start mx-auto p-[21px] sm:px-5 w-full">
        <div className="flex flex-col items-start justify-start max-w-[1320px] mb-8 mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[92px] w-full">
            ...
            <div className="h-56 relative w-[41%] md:w-full">
              <div className="flex flex-col gap-3.5 h-full items-start justify-start ml-6 mt-[29px] w-[44%]">
                <div className="flex flex-col gap-[22px] items-start justify-start w-[83%] md:w-full">
                  ...
                  <div className="flex flex-row gap-[13px] items-start justify-start w-full">
                    ...
                    <Text className="font-bold text-white_A700" variant="body6">
                      Clayton Santos
                    </Text>
                  </div>
                </div>
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-row gap-[15px] items-center justify-center w-auto">
                    <Text
                      className="font-normal text-blue_gray_600 w-auto"
                      variant="body6"
                    >
                      Email:
                    </Text>
                    <a
                      href="mailto:johny-perry@gmail.com"
                      className="font-bold text-[15px] text-white_A700 underline w-auto"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <Text>johny-perry@gmail.com</Text>
                    </a>
                  </div>
                </div>
              </div>
              <Input
                ...
                className="font-semibold justify-center p-0 placeholder:text-white_A700 text-left text-white_A700 text-xs w-full"
                type="password"
                name="groupFortyTwo"
