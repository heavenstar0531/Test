            ...
            <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
              <div className="flex md:flex-1 flex-col gap-11 items-center justify-start w-[24%] md:w-full">
                ...
                <div className="flex flex-col gap-3 items-center justify-start w-full">
                  ...
                  <div className="md:h-[495px] h-[496px] relative w-full">
                    <div className="h-[495px] m-auto outline outline-[1px] outline-gray_900_02 rounded-[20px] w-full"></div>
                    <div className="absolute flex flex-col gap-4 h-max inset-[0] items-center justify-center m-auto w-[90%]">
                      <div className="flex flex-col items-center justify-start w-[90%] md:w-full">
                        ...
                        <div className="flex flex-row items-start justify-start mt-[31px] w-[98%] md:w-full">
                          <div className="flex flex-col h-[30px] items-center justify-start w-[30px]">
                            <Img
                          ...
                          <a
                            ...
                            className="font-bold ml-5 mt-2 text-blue_gray_500"
                          >
                            <Text variant="body10">Support</Text>
                          </a>
                          <Img
                            src="images/img_arrowright_blue_gray_500.svg"
                      ...
                      <List
                        ...
                        orientation="vertical"
                      >
                        <MyDataColumnnotifications className="bg-blue_A700 hover:cursor-pointer flex flex-1 flex-col items-center justify-start p-[15px] rounded-[30px] hover:shadow-bs5 shadow-bs5 w-full" />
                        <div className="hover:cursor-pointer flex md:flex-1 flex-row items-center justify-start hover:shadow-bs5 w-[90%] md:w-full">
                          <Img
              ...
              <div className="md:h-[1065px] sm:h-[954px] h-[956px] relative w-3/4 md:w-full">
                <Text
                ...
                <div className="absolute border border-gray_900_02 border-solid flex flex-col h-full inset-[0] items-center justify-center m-auto p-6 sm:px-5 rounded-[20px] w-full">
                  <div className="flex flex-col items-start justify-start mb-[766px] mt-[27px] w-full">
                    <Text
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-3.5 w-full">
                      <Text
                        className="font-semibold md:mt-0 mt-[3px] text-white_A700"
                        variant="body7"
                      >
                        4852111
                      </Text>
                      <Text
                        className="font-semibold md:ml-[0] ml-[268px] md:mt-0 mt-1 text-white_A700"
                        variant="body7"
                      >
                        Enterprise
                      </Text>
                      <Text
                        className="font-semibold md:ml-[0] ml-[11px] md:mt-0 mt-1 text-blue_gray_500 underline"
                        variant="body7"
                      >
                        Change
                      </Text>
                      <div className="h-6 md:ml-[0] ml-[156px] relative w-[35%] md:w-full">
                        <CheckBox
                          className="font-semibold m-auto text-left text-sm text-white_A700"
                        ...
                        ></CheckBox>
                        <CheckBox
                          className="font-semibold my-auto text-left text-sm text-white_A700"
                          inputClassName="absolute h-6 mr-[5px] w-6"
                          name="paidto20052023"
                          id="paidto20052023"
                          label="Paid to 20.05.2023"
                          shape="CircleBorder12"
                          size="md"
                          variant="OutlineBlueA700"
                        ></CheckBox>
