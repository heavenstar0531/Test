      ...
      <div className="bg-black_900 flex flex-col font-inter items-center justify-start mx-auto p-[21px] sm:px-5 w-full">
        <div className="flex flex-col items-start justify-start max-w-[1320px] mb-8 mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-6 items-start justify-between mt-[92px] w-full">
            ...
            <div className="border border-gray_900_02 border-solid flex md:flex-1 flex-col items-center justify-start p-6 sm:px-5 rounded-[20px] w-3/4 md:w-full">
              <div className="flex flex-col items-start justify-start my-[3px] w-full">
                <Text className="font-bold text-blue_gray_600" variant="body8">
                  Share link
                </Text>
                <Text
                  className="font-semibold mt-2 text-white_A700"
                  variant="body3"
                >
                  Share link and get some rewards
                </Text>
                <div className="flex sm:flex-col flex-row gap-[23px] items-center justify-between mt-[23px] w-full">
                  <Input
                    wrapClassName="flex sm:flex-1 sm:w-full"
                    className="font-normal p-0 placeholder:text-blue_gray_500 text-blue_gray_500 text-left text-sm w-full"
                    name="groupSeventyTwo"
                    placeholder="http://lagx.game/referral&id=23422416"
                    suffix={
                      <Img
                        src="images/img_videocamera_blue_gray_500.svg"
                  ...
                  ></Input>
                  <Button
                    className="cursor-pointer font-semibold min-w-[113px] text-center text-white_A700 text-xs"
          ...
          <div className="h-[514px] md:h-[525px] mt-3 relative w-[24%]">
